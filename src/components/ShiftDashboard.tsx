...
export const ShiftDashboard: React.FC<ShiftDashboardProps> = ({ 
  ...
  const handleCashOut = async (shouldPrint: boolean) => {
    const message = shouldPrint 
      ...
      : "CONFIRM CASH OUT?\n\nThis will DELETE all order history for the day WITHOUT printing.\n\nAre you sure you want to close the shift?";
              ...
              <div className="col-span-1 md:col-span-2 bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-slate-200 dark:border-neutral-800 p-8 flex flex-col items-center">
                 ...
                 <div className="mt-8 flex flex-col sm:flex-row gap-4">
                   <button 
                     ...
                     className="bg-red-600 text-white px-8 py-3 rounded-lg hover:bg-red-700 transition-colors flex items-center justify-center gap-2 shadow-lg shadow-red-200 dark:shadow-none font-bold"
                   >
                     <Printer size={18} />
                   ...
                   <button 
                     ...
                     className="bg-slate-800 dark:bg-slate-700 text-white px-8 py-3 rounded-lg hover:bg-slate-900 dark:hover:bg-slate-600 transition-colors flex items-center justify-center gap-2 shadow-lg shadow-slate-200 dark:shadow-none font-bold"
                   >
                     Cash Out Only (No Print)
                   </button>
                 </div>
              </div>
