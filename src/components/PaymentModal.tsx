...
export const PaymentModal: React.FC<PaymentModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/70 backdrop-blur-sm animate-in fade-in duration-200 p-2 md:p-4">
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full h-full max-h-[90vh] flex flex-col lg:flex-row overflow-hidden border border-slate-200 dark:border-slate-800">
